...
public abstract class BaseElement extends BaseEntity {
    ...
    protected BaseElement(String stringLocator, final String nameOfElement) {
        ...
        if (stringLocator.contains(CSS)) {
            ...
            name = nameOfElement;
        }else if (stringLocator.contains(XPATH)) {
            clearLoc = stringLocator.replaceFirst(XPATH, "");
            locator = By.xpath(clearLoc);
            name = nameOfElement;
        } else if (stringLocator.contains(CLASSNAME)) {
            clearLoc = stringLocator.replaceFirst(CLASSNAME, "");
            ...
            name = nameOfElement;
        } else if (stringLocator.contains(NAME)) {
            clearLoc = stringLocator.replaceFirst(NAME, "");
            locator =By.name(clearLoc);
            name = nameOfElement;
        }else {
